               ...
               <div className="bg-surface/30 border border-white/10 rounded-[2.5rem] p-8 md:p-12 min-h-[600px]">
                  {activeTab === 'getting-started' && (
                     <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <h1 className="text-4xl font-black text-white mb-8">Getting Started with Meta Ai  </h1>
                        <p className="text-slate-300 text-lg leading-relaxed">
                           MetaAi Automator is a powerful Chrome Extension designed to streamline your AI image generation workflow.
                           Whether you are using Midjourney, Stable Diffusion, or other web-based generators, Meta Ai   helps you scale from dozens to thousands of images effortlessly.
                        </p>
                     ...
                     <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="space-y-8">
                           <div>
                              ...
                              <p className="text-slate-300 mb-4">You can install MetaAi Automator directly from the Chrome Web Store or manually via Developer Mode.</p>
                           ...
                           <div>
                              ...
                              <p className="text-slate-300">Click the puzzle piece icon in Chrome and pin MetaAi Automator for easy access.</p>
                           </div>
                           <div>
