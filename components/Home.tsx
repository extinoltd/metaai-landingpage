...
const TESTIMONIALS = [
  ...
  {
    rating: 5,
    quote: "Compared to other free MetaAi Automator tools, this pays for itself in one day. The auto downloader saves my wrist.",
    name: "James Kim",
  ...
  return (
    <>
      ...
      <header className="relative pt-40 pb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10 reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 reveal reveal-delay-300">
            ...
            <Button variant="secondary" size="lg" className="flex items-center gap-2" onClick={() => setIsVideoModalOpen(true)}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 relative reveal">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 uppercase italic inline-block relative text-white">
              {t.comparison.title} <span className="text-primary">MetaAi Automator</span>
      ...
      <section id="pricing" className="py-24 relative section-glow scroll-mt-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-slate-400">Better than free MetaAi Automator tools. Professional support included.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
            <div className="p-8 rounded-[2rem] bg-surface/40 border border-white/5 hover:border-white/10 transition-all text-center group relative reveal reveal-delay-200">
              ...
              <div className="flex items-center justify-center gap-2 mb-6">
                <span className="text-slate-500 line-through text-lg">£6.99</span>
              ...
              <Button variant="secondary" className="w-full" onClick={() => window.open(EXTENSION_URL, '_blank')}>{t.pricing.monthly}</Button>
            </div>
            ...
            <div className="p-8 rounded-[2rem] bg-surface/40 border border-white/5 hover:border-white/10 transition-all text-center group relative reveal reveal-delay-300">
              ...
              <Button variant="secondary" className="w-full" onClick={() => window.open(EXTENSION_URL, '_blank')}>{t.pricing.lifetime}</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      {isVideoModalOpen && (
        ...
        >
          <div
            className="relative w-full max-w-5xl aspect-video bg-surface/95 backdrop-blur-md rounded-[2.5rem] border-2 border-primary shadow-[0_0_80px_rgba(250,204,21,0.4)] overflow-hidden animate-scale-in"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={() => setIsVideoModalOpen(false)}
              className="absolute top-4 right-4 z-10 w-12 h-12 bg-black/80 hover:bg-primary text-white hover:text-black rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:scale-110 border border-white/20 hover:border-primary"
