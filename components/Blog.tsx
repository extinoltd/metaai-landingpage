...
const POSTS = [
  {
    id: 1,
    title: "How to use a prompt list with Meta Ai   AI",
    excerpt: "A step-by-step guide to uploading CSVs and using Meta Ai   AI batch processing for maximum efficiency.",
    date: "Oct 12, 2025",
    author: "Sarah Connor",
  ...
  {
    id: 2,
    title: "The fastest way to generate 100 images in Meta Ai  ",
    excerpt: "Stop clicking. Learn how to automate Meta Ai   prompts to generate 100+ coherent images in minutes.",
    date: "Sep 28, 2025",
    author: "John Matrix",
  ...
  {
    id: 3,
    title: "Meta Ai   tips for designers: Exporting in Bulk",
    excerpt: "Why we are the best Meta Ai  Automator alternative. Learn how to export Meta Ai   AI images in bulk with metadata.",
    date: "Sep 15, 2025",
    author: "Team Meta Ai  ",
...
export const Blog = () => {
  ...
  useEffect(() => {
    ...
    link.setAttribute('href', `https://metaaiautomator.com/?view=blog&page=${pageParam}`);
    ...
    <div className="pt-32 pb-24 px-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-xl">Expert tutorials on Meta Ai   workflow automation.</p>
        </div>
