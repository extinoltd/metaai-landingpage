        ...
        <div className="bg-surface/30 border border-white/10 rounded-[2.5rem] p-8 md:p-12 space-y-12">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              MetaAi Automator ("we," "our," or "us") values your privacy. This Privacy Policy explains how we collect, use, and share information about you when you use our website (metaaiautomator.com) and our Chrome Extension. 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              <li>To provide and maintain the functionality of the MetaAi Automator extension.</li>
