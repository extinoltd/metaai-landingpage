        ...
        <div className="bg-surface/30 border border-white/10 rounded-[2.5rem] p-8 md:p-12 space-y-12">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              At MetaAi Automator, we prioritize local processing. Most of your data is stored in your browser's <strong>Local Storage</strong> rather than traditional tracking cookies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              To clear MetaAi Automator data, simply uninstall the extension or clear your browser's "Local Storage" for <code>metaaiautomator.com</code>.
            </p>
          </section>
          ...
          <section className="pt-8 border-t border-white/10">
            ...
            <a href="mailto:privacy@metaaiautomator.com" className="text-primary font-bold hover:underline">privacy@metaaiautomator.com</a>
          </section>
