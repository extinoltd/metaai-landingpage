        ...
        <div className="bg-surface/30 border border-white/10 rounded-[2.5rem] p-8 md:p-12 space-y-12">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              By accessing or using MetaAi Automator (the "Service"), you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.
            </p>
          </section>
          ...
          <section className="pt-8 border-t border-white/10">
            ...
            <a href="mailto:support@metaaiautomator.com" className="text-primary font-bold hover:underline">support@metaaiautomator.com</a>
          </section>
