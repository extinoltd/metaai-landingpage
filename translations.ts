...
export const translations = {
  ...
  ja: {
    ...
    hero: {
      ...
      titleMiddle: "画像生成",
      titleSuffix: "Google Whisk。",
      subtitle: "Google Whisk プロンプトを自動化し、すべての画像を即座にダウンロードします。プロフェッショナル向け Meta Ai ワークフロー自動化ツール。",
  ...
  ko: {
    ...
    hero: {
      ...
      titleMiddle: "이미지 생성",
      titleSuffix: "Google Whisk.",
      subtitle: "Google Whisk 프롬프트를 자동화하고 모든 이미지를 즉시 다운로드하세요. 전문가를 위한 포괄적인 Meta Ai 워크플로우 자동화 도구입니다.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Google Whisk가 왜 느린가요?", a: "MetaAi Automator이 대기열을 관리하여 가장 빠른 생성 시간을 보장합니다." },
  ...
  tr: {
    ...
    hero: {
      ...
      subtitle: "Google Whisk istemlerini otomatikleştirin ve tüm görüntüleri anında indirin. Profesyoneller için kapsamlı Meta Ai iş akışı otomasyon aracı.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Google Whisk neden yavaş?", a: "MetaAi Automator kuyruğu sizin için yönetir, en hızlı oluşturma sürelerini sağlar." },
  ...
  bn: {
    ...
    hero: {
      ...
      subtitle: "Google Whisk প্রম্পট স্বয়ংক্রিয় করুন এবং অবিলম্বে সমস্ত ছবি ডাউনলোড করুন। পেশাদারদের জন্য ব্যাপক Meta Ai ওয়ার্কফ্লো অটোমেশন টুল।",
...
export const FEATURE_LIST = [
  { icon: Layers, title: "Whisk AI Batch Processing", desc: "Upload thousands of prompts at once. The ultimate answer to how to bulk generate images in Meta Ai." },
